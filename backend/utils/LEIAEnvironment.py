...
ONTOGEN_HOST = os.environ["ONTOGEN_HOST"] if "ONTOGEN_HOST" in os.environ else "localhost"
ONTOGEN_PORT = os.environ["ONTOGEN_PORT"] if "ONTOGEN_PORT" in os.environ else "5005"
...
def ontogen_service():
    return "http://" + ONTOGEN_HOST + ":" + ONTOGEN_PORT
